(function() {
    ...
    window.clicktodial = (function() {
        var dial = function(b_number, tab, silent) {
			...
			var phoneAccountId = userData.userdestination.selecteduserdestination.phoneaccount.toString();
			var phoneAccounts = userData.userdestination.phoneaccounts;
			var a_number;
			
			for (var i = 0; i < phoneAccounts.length; i++) {
				if (phoneAccounts[i].id === phoneAccountId) {
					a_number = phoneAccounts[i].internal_number;
				}
			}
                ...
                'post',
                {
                    onOk: function(response) {
                        ...
                        if(silent) {
                             ...
                             * the call faile to connect both sides, a notification
                             * will show.
                             */
